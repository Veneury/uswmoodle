...
/**
 * Strings for component 'theme_uswtwo', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_uswtwo
...
$string['pluginname'] = 'USW2';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>uswtwo</h2><img src="uswtwo/pix/screenshot.png" alt="uswtwo screenshot" /></div></div>
<br />
<p>uswtwo has been created to combine my favourite elements of several themes into a single location:
<ol>
<li>Responsive layouts from Danny Wahls Zebra theme</li>
<li>AwesomeBar menu from uswtwo by Lei Zhang/Paul Nicholls</li>
...
$string['configtitle'] = 'uswtwo theme settings';
...
<div id="plsnote"><p><strong>Please Note:</strong>This section is styled within the uswtwo theme and may not look correct if viewed in other themes.</p>';
