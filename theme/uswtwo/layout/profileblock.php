...
<!--                        <a href="<?php echo $CFG->wwwroot; ?>/user/editadvanced.php"><li><img src="<?php echo $OUTPUT->pix_url('profile/editprofile', 'theme')?>" />&nbsp;<?php echo get_string('editmyprofile');?></li></a> -->
			...
			<td valign="top" width="50%"><ul>
           	...
           	<a href="<?php echo $CFG->wwwroot; ?>/message/index.php"><li><img src="<?php echo $OUTPUT->pix_url('profile/messages', 'theme')?>" />&nbsp;<?php echo get_string('messages','message');?></li></a>
			<?php if ($hasemailurl) {?><a href="<?php echo $PAGE->theme->settings->emailurl;?> "><li><img src="<?php echo $OUTPUT->pix_url('profile/email', 'theme')?>" />&nbsp;<?php echo get_string('email','theme_uswtwo');?></li></a> <?php } else {}?>
