...
function insert_analytics_tracking() {
    global $PAGE;
    $enabled = theme_essential2_get_setting('useanalytics');
    $siteid = theme_essential2_get_setting('analyticsid');
    $cleanurl = theme_essential2_get_setting('analyticsclean');
    $trackadmin = theme_essential2_get_setting('analyticsadmin');
