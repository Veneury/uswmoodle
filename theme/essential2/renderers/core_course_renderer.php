...
class theme_essential2_core_course_renderer extends core_course_renderer {
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        ...
        if(theme_essential2_get_setting('enablecategoryicon')) {
            if(theme_essential2_get_setting($categoryiconnum) && 
               theme_essential2_get_setting('enablecustomcategoryicon')) {
                // User has set a value for the category
                $val = theme_essential2_get_setting($categoryiconnum);
            } else {
                // User hasn't set a value for the category, get the default
                $val = theme_essential2_get_setting('defaultcategoryicon');
            }
        }
        if(!empty($val)) {
