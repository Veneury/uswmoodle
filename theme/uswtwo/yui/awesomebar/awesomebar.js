YUI.add('moodle-theme_uswtwo-awesomebar', function(Y) {
...
AwesomeBar.prototype = {
    ...
    initializer : function(config) {
        Y.all('.uswtwo-awesome-bar ul.dropdown li > span').each(this.enhanceAwesomeBar, this);
        Y.all('.uswtwo-awesome-bar ul.dropdown li.clickable-with-children > a').each(this.enhanceAwesomeBar, this);
    },
...
M.theme_uswtwo.initAwesomeBar = function(cfg) {
