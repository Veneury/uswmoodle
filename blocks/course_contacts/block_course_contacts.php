...
class block_course_contacts extends block_base {
	...
	public function get_content(){
		...
		$userfields = 'u.id,u.lastaccess,u.firstname,u.lastname,u.email,u.phone1,u.picture,u.imagealt,u.lastnamephonetic,u.firstnamephonetic,u.middlename,u.alternatename,u.description';
...
//						}
							$content .= html_writer::start_tag('div', array('class' => 'officehours'));
							$description = substr($contact->description, 0, 200);
							if (strlen($contact->description) >200) {
								$description .= '...';
							}
							$content .= $description; 
							$content .= html_writer::end_tag('div');
