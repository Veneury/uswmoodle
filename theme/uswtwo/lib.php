 ...
 * @return string
 */
function uswtwo_performance_output($param) {
 ...
 * @return string
 */
function uswtwo_process_css($css, $theme) {
global $USER;
    ...
    $css = uswtwo_set_backgroundcolor($css, $backgroundcolor);
    ...
    $css = uswtwo_set_logourl($css, $logourl);
    ...
    $css = uswtwo_set_menubackgroundcolor($css, $menubackgroundcolor);
    ...
    $css = uswtwo_set_customcss($css, $customcss);
    ...
    $css = uswtwo_set_userbackground($css, $userbackground);
    ...
    $css = uswtwo_set_userfontcolour($css, $userfontcolour);
    ...
    $css = uswtwo_set_userlinkcolour($css, $userlinkcolour);    
 ...
 * @return string
 */
function uswtwo_set_backgroundcolor($css, $backgroundcolor) {
...
function uswtwo_set_logourl($css, $logourl) {
    global $OUTPUT;
    $tag = '[[setting:logourl]]';
    if (is_null($logourl)) {
 ...
 * @return string
 */
function uswtwo_set_menubackgroundcolor($css, $menubackgroundcolor) {
 ...
 * @return string
 */
function uswtwo_set_userbackground($css, $userbackground) {
 ...
 * @return string
 */
function uswtwo_set_userfontcolour($css, $userfontcolour) {
 ...
 * @return string
 */
function uswtwo_set_userlinkcolour($css, $userlinkcolour) {
 ...
 * @return string
 */
function uswtwo_set_customcss($css, $customcss) {
 ...
 *     theme/uswtwo/yui/editbuttons/editbuttons.js
 *
 * @param moodle_page $page 
 */
function uswtwo_initialise_editbuttons(moodle_page $page) {
    $page->requires->string_for_js('edit', 'moodle');
    $page->requires->yui_module('moodle-theme_uswtwo-editbuttons', 'M.theme_uswtwo.initEditButtons');
}

function uswtwo_initialise_awesomebar(moodle_page $page) {
    $page->requires->yui_module('moodle-theme_uswtwo-awesomebar', 'M.theme_uswtwo.initAwesomeBar');
}

function uswtwo_require_course_login($courseorid, $autologinguest = true, $cm = NULL, $setwantsurltome = true, $preventredirect = true) {
    global $CFG, $SITE;
    ...
    if (!empty($CFG->forcelogin)) {
        ...
        uswtwo_require_login($courseorid, $autologinguest, $cm, $setwantsurltome, $preventredirect);
...
function uswtwo_require_login($courseorid = NULL, $autologinguest = true, $cm = NULL, $setwantsurltome = true, $preventredirect = false) {
...
class uswtwo_expand_navigation extends global_navigation {
    ...
    public function expand($branchtype, $id) {
        global $CFG, $DB, $PAGE;
        static $uswtwo_expanded_courses = array();
        ...
        switch ($branchtype) {
            ...
            case self::TYPE_COURSE :
                ...
                try {
                    if(!array_key_exists($course->id, $uswtwo_expanded_courses)) {
                        ...
                        if ($PAGE->course->id == $course->id && (!method_exists($this, 'format_display_course_content') || $this->format_display_course_content($course->format))) {
                            uswtwo_require_course_login($course);
                            $uswtwo_expanded_courses[$course->id] = $this->load_course_sections($course, $coursenode);
                        }
                    }
            ...
            case self::TYPE_SECTION :
                ...
                try {
                    ...
                    if (empty($uswtwo_expanded_courses[$course->id])) {
                        ...
                        $uswtwo_expanded_courses[$course->id] = $sectionnodes;
                    }
                    $sections = $uswtwo_expanded_courses[$course->id];
...
class uswtwo_dummy_page extends moodle_page {
    /**
