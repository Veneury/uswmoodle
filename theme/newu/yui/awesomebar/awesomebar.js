YUI.add('moodle-theme_newu-awesomebar', function(Y) {
...
AwesomeBar.prototype = {
    ...
    initializer : function(config) {
        Y.all('.newu-awesome-bar ul.dropdown li > span').each(this.enhanceAwesomeBar, this);
        Y.all('.newu-awesome-bar ul.dropdown li.clickable-with-children > a').each(this.enhanceAwesomeBar, this);
    },
...
M.theme_newu.initAwesomeBar = function(cfg) {
