...
/**
 * Strings for component 'theme_newu', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   theme_newu
...
$string['pluginname'] = 'NewU';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>newu</h2><img src="newu/pix/screenshot.png" alt="newu screenshot" /></div></div>
<br />
<p>newu has been created to combine my favourite elements of several themes into a single location:
<ol>
<li>Responsive layouts from Danny Wahls Zebra theme</li>
<li>AwesomeBar menu from newu by Lei Zhang/Paul Nicholls</li>
...
$string['configtitle'] = 'newu theme settings';
...
<div id="plsnote"><p><strong>Please Note:</strong>This section is styled within the newu theme and may not look correct if viewed in other themes.</p>';
